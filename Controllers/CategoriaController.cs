...
namespace EstoqueWeb.Controllers
{
    public class CategoriaController : Controller {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.Categorias.OrderBy(o => o.Nome).AsNoTracking().ToListAsync());
        }
        [HttpGet]
        ...
        {
            return _context.Categorias.Any(o => o.IdCategoria == id);
        }
        ...
        public async Task<IActionResult> Cadastrar(int? id, [FromForm] CategoriaModel categoria)
        {
            if(ModelState.IsValid)
            {
                if(id.HasValue)
                {
                    ...
                    {
                        TempData["mensagem"] = MensagemModel.Serializar("Categoria nao encontrada", TipoMensagem.Erro);
                    }
                }
                else
                {
